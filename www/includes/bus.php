  ...
  <div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <form action="/busdetail.php" method="GET" class="container flex mx-auto px-4 py-2 md:py-10">
      ...
      <div class="ml-3">
            ...
            <select name="time" id="time" class="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none text-gray-600 font-medium focus:ring focus:ring-blue-600 focus:ring-opacity-50>">
                <?php 
