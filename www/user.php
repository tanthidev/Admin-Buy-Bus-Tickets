                        ...
                        <div class="hidden bg-transparent w-full text-base z-50 list-none divide-y divide-gray-100 rounded shadow my-4" id="dropdown">
                            <div class="px-4">
                                <ul class="py-1" aria-labelledby="dropdown">
                                    ...
                                    <li>
                                        <a href="#" class="py-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block hover:text-white border-b-2 border-gray-800 hover:border-blue-600">Bus</a>
                                    </li>
                                    <li>
